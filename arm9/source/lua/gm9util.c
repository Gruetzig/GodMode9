...
static int util_utf16_to_utf8(lua_State* L) {
...
static int util_utf8_to_utf16(lua_State* L) {
...
static const luaL_Reg util[] = {
    {"utf16_to_utf8", util_utf16_to_utf8},
    {"utf8_to_utf16", util_utf8_to_utf16},
    {NULL, NULL}
};

int gm9lua_open_util(lua_State* L) {
    luaL_newlib(L, util);
    return 1;
}
